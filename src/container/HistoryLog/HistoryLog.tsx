          ...
          <React.Fragment>
            <div className={'container'}>
              <div className={'row justify-content-center'}>
                {
                  history.length > 0 ? history.map((historyWeek: any, i:number) => {
                    return (
                      <div className={'col-md-6 my-4'} key={i}>
                        <React.Fragment>
                          <div className={'date_section'}>
                            <p><strong>Date: </strong> {Object.keys(historyWeek)[0]}</p>
                          </div>

                          <div className={'history_logs'}>
                            <ul>
                              {
                                history[i][Object.keys(historyWeek)[0]].map((m: any) => (
                                  <React.Fragment>
                                    <li>
